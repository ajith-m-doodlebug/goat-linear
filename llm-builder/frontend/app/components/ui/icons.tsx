  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6 6 0 00-6-6v0a6 6 0 00-6 6v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"
      />
    </svg>
  );
}
...
export function HomeIcon({ className = "" }: { className?: string }) {
  return (
    <svg className={`${sizeClass} ${className}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
...
/** Monitor / workstation — used for self-hosted inference (distinct from CpuIcon for Models). */
